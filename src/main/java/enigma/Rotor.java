...
public class Rotor {
    ...
    public int getPosition() {                                                  //cette fonction récupère la position du rotor
        return position;                                                        //puis la renvoie
    }

    public void setPosition(int posn) {                                         //cette position définie la position du rotor
        position = posn;
    }
